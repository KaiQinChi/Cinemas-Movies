<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="EditComingMovie.aspx.cs" Inherits="s3357335_a2.EditComingMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div style="padding-bottom: 0.5em">
        <h4><span class="label label-default">Edit Coming Movie</span></h4>
    </div>
    ...
    <div class="form-group" style="width: 600px">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldReleaseTime" runat="server" ErrorMessage=" (Please enter date time!)" ControlToValidate="releaseTime" ForeColor="#FF3300" />
